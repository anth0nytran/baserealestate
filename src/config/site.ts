...
export interface City {
    ...
    slug: string;
    /**
     * Base name of the photograph in /public/neighborhoods, or null when no
     * licensed image of this city exists yet. Null renders a typographic tile
     * rather than a stand-in photo — a coastal shot captioned "Dana Point"
     * that was taken in Newport is a false claim about a place.
     *
     * TODO(client): supply photography for the null entries and re-run
     * `npm run images:brand` after dropping files into
     * assets/renders/neighborhoods-curated/<slug>.webp.
     */
    photo: string | null;
...
export const AREA = {
    ...
    cities: [
        { name: "Newport Beach", slug: "newport-beach", photo: "newport-beach", note: "Harbour, peninsula, and the bluffs above it" },
        { name: "Laguna Beach", slug: "laguna-beach", photo: null, note: "Coves, canyon lots, and a market of one-offs" },
        { name: "Dana Point", slug: "dana-point", photo: null, note: "Harbour-side, Monarch Beach, and the headlands" },
        { name: "Laguna Niguel", slug: "laguna-niguel", photo: null, note: "Inland hills with coastal access" },
        { name: "Huntington Beach", slug: "huntington-beach", photo: "huntington-beach", note: "Downtown, Huntington Harbour, and the wetlands" },
        { name: "Costa Mesa", slug: "costa-mesa", photo: "costa-mesa", note: "Eastside character, close to everything" },
        { name: "Irvine", slug: "irvine", photo: "irvine", note: "Villages, schools, and predictable inventory" },
 ...
 *
 * Regenerated by `npm run images:brand`; the PNG originals live in
 * public/services/source/ and are never served.
 */
